...
public class Build {
	 ...
	 * 
	 * @throws IOException              If there's any error within the file
	 *                                  reading
	...
	/**
	 * Loads a graph in a file and tries to find a Strongly Connected Components using DFS.
	 * 
	...
	public static void main(String[] args) throws IOException, IllegalArgumentException {
		if (args.length <= 0) {
			throw new IllegalArgumentException("Uso: java Build <nombreArchivo>");
		}

		Grafo g = loadGraph(args[0]);
		SCComponents scc = new SCComponents(g);
		System.out.println("El total de edificios en la ciudad ensamblada es: " + scc.GetNumberSC());
	}
}