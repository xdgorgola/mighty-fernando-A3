...
public interface Grafo {
    ...
    /**
     * Intenta agregar un vertice v al grafo g. Si un vertice con el mismo identificador ya se encuentra 
     * en el grafo g, no hace nada.
    ...
    /**
     * Se crea un nuevo vertice v al grafo con distintos atributos deseados y se intenta agregar en el
     * grafo g. Si un vertice con el mismo identificador se encuentra en el grafo g, no hace nada.
     * @param g Grafo a agregar vertice.
    ...
    /**
     * Se elimina del grafo g un vertice con cierto identificador. Si no existe un vertice con ese identiicador
     * en el grafo g, no hace nada.
    ...
    /**
     * Busca un vertice con cierto identificador en el grafo g y lo retorna. Si el vertice no se encuentra  en
     * el grao g, levanta una excepcion.
     ...
     * @throws NoSuchElementException Si el vertice de identificador id no se encuentra en el grafo g.
     */
    public Vertice obtenerVertice(Grafo g, int id) throws NoSuchElementException;
    
    /**
     * Retorna los vertices de un grafo g como una lista enlazada que contiende objetos
     * de la clase <code>Vertice</vertice> que representan los vertices del grafo g
     ...
     * @return ArrayList con los lados de un grafo g, representados con el objeto <code>Lado</code>.
     */
     ...
     * @throws NoSuchElementException Si el vertice a calcular el grado no se encuentra en el grafo.
     */
    ...
    /**
     * Busca los lados incidentes de un vertice con cierto identificador en un grafo y los devuelve.
